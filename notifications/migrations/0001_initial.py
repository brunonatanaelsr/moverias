    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "push_enabled",
                    models.BooleanField(default=True, verbose_name="Push"),
                ),
                ...
                (
                    ...
                    models.BooleanField(default=True, verbose_name="Workshops"),
                ),
                (
                    "certificate_notifications",
                    models.BooleanField(default=True, verbose_name="Certificados"),
                ),
                (
                    "project_notifications",
                    models.BooleanField(default=True, verbose_name="Projetos"),
                ),
                (
                    "coaching_notifications",
                    models.BooleanField(default=True, verbose_name="Coaching"),
                ),
                (
                    "system_notifications",
                    models.BooleanField(default=True, verbose_name="Sistema"),
                ),
                (
                    "quiet_hours_start",
                    models.TimeField(
                        default="22:00", verbose_name="Início do Silêncio"
                    ),
                ),
                (
                    "quiet_hours_end",
                    models.TimeField(default="08:00", verbose_name="Fim do Silêncio"),
                ),
                (
                    "frequency_limit",
                    models.IntegerField(
                        default=10, verbose_name="Limite de Notificações por Dia"
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "failed_count",
                    models.IntegerField(default=0, verbose_name="Falharam"),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "html_message",
                    models.TextField(blank=True, verbose_name="Mensagem HTML"),
                ),
                (
                    "type",
                    models.CharField(
