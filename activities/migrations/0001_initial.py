    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "facilitator",
                    models.CharField(
                        max_length=100, verbose_name="Facilitador/Responsável"
                    ),
                ),
                ...
                (
                    ...
                    models.IntegerField(
                        ...
                        verbose_name="Pontuação de Impacto",
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "materials_used",
                    models.TextField(blank=True, verbose_name="Materiais Utilizados"),
                ),
                (
                    "content_covered",
                    models.TextField(blank=True, verbose_name="Conteúdo Abordado"),
                ),
                (
                    "objectives_achieved",
                    models.TextField(blank=True, verbose_name="Objetivos Alcançados"),
                ),
                (
                    "observations",
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="activities.beneficiaryactivity",
            ...
            fields=[
                ...
                (
                    ...
                    models.IntegerField(
                        ...
                        default=5,
                        verbose_name="Qualidade do Conteúdo",
                    ),
                ),
                (
                    "facilitator_rating",
                    models.IntegerField(
                        ...
                        default=5,
                        verbose_name="Avaliação do Facilitador",
                    ),
                ),
                (
                    "positive_aspects",
                ...
                (
                    ...
                    models.TextField(blank=True, verbose_name="Sugestões de Melhoria"),
                ),
                (
                    "additional_comments",
                    models.TextField(blank=True, verbose_name="Comentários Adicionais"),
                ),
                (
                    "would_recommend",
                    models.BooleanField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "excuse_reason",
                    models.TextField(blank=True, verbose_name="Motivo da Falta"),
                ),
                (
                    "recorded_at",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["beneficiary", "status"], name="activities__benefic_199c3a_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="beneficiaryactivity",
            index=models.Index(
                ...
                name="activities__activit_3ef0dc_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="beneficiaryactivity",
            index=models.Index(
                fields=["start_date", "end_date"], name="activities__start_d_b5f12f_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="activitysession",
            index=models.Index(
                fields=["activity", "session_date"],
                name="activities__activit_f9e73e_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="activitysession",
            index=models.Index(
                fields=["status", "session_date"], name="activities__status_0813f3_idx"
            ),
        ),
