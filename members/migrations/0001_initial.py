        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "nis",
                    models.CharField(
                        blank=True, max_length=15, null=True, verbose_name="NIS"
                    ),
                ),
                ...
                (
                    "reference",
                    models.TextField(blank=True, verbose_name="Ponto de Referência"),
                ),
                (
                    "status",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "lgpd_agreement",
                    models.BooleanField(
                        default=False, verbose_name="Concordo com LGPD"
                    ),
                ),
                (
                    "image_use_agreement",
                    models.BooleanField(
                        default=False, verbose_name="Concordo com uso de imagem"
                    ),
                ),
                (
                    "signed_at",
                ...
                (
                    "signed_ip",
                    models.GenericIPAddressField(verbose_name="IP da assinatura"),
                ),
                (
                    "pdf",
                    models.FileField(
